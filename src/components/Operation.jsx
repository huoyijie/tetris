...
export default function () {
  ...
  return (
    <div className='flex flex-col gap-2 items-center'>
      ...
      <div className='w-full'><button className='w-full border rounded-lg px-6 py-3 bg-slate-400 text-white hover:bg-slate-600 active:bg-slate-400 focus:outline-none' onClick={next}>Next</button></div>
    </div>
  )
}